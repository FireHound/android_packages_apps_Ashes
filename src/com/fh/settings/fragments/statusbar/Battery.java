...
public class Battery extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.fh_battery);
        ...
        boolean hideForcePercentage = batteryStyle == 8 || batteryStyle == 9; /*text or hidden style*/
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mBatteryIconStyle) {
            ...
            boolean hideForcePercentage = value == 8 || value == 9;/*text or hidden style*/
            mBatteryPercentage.setEnabled(!hideForcePercentage);
            return true;
